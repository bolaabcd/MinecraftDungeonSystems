...
public class Addtemporizator implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label,
		...
		if (sender instanceof Player) {
			...
			tempo=Integer.valueOf(args[8]);
			}
			catch(NumberFormatException n) {
				player.sendMessage(ChatColor.RED+"Coordenadas inválidas (ou tempo inválido)!");
				return true;
			}
			try {
